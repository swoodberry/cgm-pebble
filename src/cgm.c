...
static const uint16_t LOW_BG_MGDL = 73;

static const uint16_t HIGH_BG_MGDL = 155;
static const uint16_t MIDHIGH_BG_MGDL = 220;
...
static const uint16_t LOW_BG_MMOL = 40;

static const uint16_t HIGH_BG_MMOL = 86;
static const uint16_t MIDHIGH_BG_MMOL = 122;
